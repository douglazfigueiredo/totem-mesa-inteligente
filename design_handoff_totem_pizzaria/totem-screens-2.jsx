      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 10, justifyContent: 'center' }}>
        ...
        <div className="col" style={{ gap: 6, fontSize: 13 }}>
          <div className="row between wf-box" style={{ padding: 8 }}>
            ...
            <span className="wf-pill accent" style={{ fontSize: 11, padding: '2px 8px' }}>preparando</span>
          </div>
          <div className="row between wf-box" style={{ padding: 8 }}>
          ...
          <div className="row between wf-box" style={{ padding: 8 }}>
            <span>· guaraná ×2</span>
            <span className="wf-pill ready" style={{ fontSize: 11, padding: '2px 8px' }}>servido ✓</span>
          </div>
        </div>
        <div className="wf-btn ghost" style={{ marginTop: 12, fontSize: 14 }}>+ pedir mais (sem perder o timer)</div>
      </div>
    </div>
...
const Timer_B = ({ pct = 0.55, time = '08:24' }) => (
  <Tablet>
    ...
    <div style={{ paddingTop: 22, height: '100%', padding: 20, display: 'flex', alignItems: 'center', gap: 20 }}>
      <div style={{ flex: 1.2, textAlign: 'center' }}>
        <div className="wf-mono">SUA PIZZA TÁ NO FORNO</div>
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: 4 }}>
          <PizzaBake size={180} pct={pct} />
        </div>
        <div className="wf-h1" style={{ fontSize: 56, marginTop: 4 }}>{time}</div>
      ...
      <div style={{ flex: 1, padding: 14, borderLeft: '1.5px dashed var(--line)' }}>
        ...
        <div className="col" style={{ gap: 8, marginTop: 8, fontSize: 13 }}>
          <div className="row" style={{ gap: 8 }}><span style={{color: 'var(--ready)'}}>✓</span> recebido</div>
          <div className="row" style={{ gap: 8 }}><span style={{color: 'var(--ready)'}}>✓</span> massa aberta</div>
          <div className="row" style={{ gap: 8 }}><span style={{color: 'var(--accent)'}}>●</span> <strong>no forno</strong></div>
          <div className="row" style={{ gap: 8, color: 'var(--ink-3)' }}><span>○</span> finalizando</div>
          <div className="row" style={{ gap: 8, color: 'var(--ink-3)' }}><span>○</span> pronta na mesa</div>
        </div>
        <div className="wf-btn" style={{ marginTop: 14, fontSize: 13 }}>continuar pedindo →</div>
      </div>
    </div>
  </Tablet>
);
    ...
    <div style={{ paddingTop: 22, height: '100%', padding: 20 }}>
      ...
      <div className="col" style={{ gap: 10 }}>
        {[
          ...
          { n: 'hamb. cheddar ×2', pct: 0.30, time: '12:10', color: 'var(--accent)', status: 'na chapa' },
          ...
          <div key={i} className="wf-box" style={{ padding: 10 }}>
            <div className="row between" style={{ marginBottom: 6 }}>
              ...
              <div className="row" style={{ gap: 10 }}>
                <span className="wf-pill" style={{ fontSize: 11, padding: '2px 8px', borderColor: it.color, color: it.color }}>{it.status}</span>
                <span className="wf-mono" style={{ fontSize: 16, color: it.color }}>{it.time}</span>
              </div>
            </div>
        ...
        <div className="wf-box" style={{ padding: 10, opacity: 0.5, borderStyle: 'dashed' }}>
          <div className="row between">
            ...
            <span className="wf-pill ready" style={{ fontSize: 11, padding: '2px 8px' }}>já chegou ✓</span>
          </div>
        </div>
      </div>
      <div className="row between" style={{ marginTop: 14 }}>
        <Annotate style={{ position: 'static' }}>cada item tem seu próprio timer · em paralelo</Annotate>
        <div className="wf-btn ghost" style={{ fontSize: 13 }}>continuar pedindo →</div>
      </div>
    </div>
  </Tablet>
);
...
const Mini_B = () => (
  <Tablet>
    ...
    <div style={{ paddingTop: 22 }}>
      <div style={{
        background: 'var(--accent-soft)', borderBottom: '2px solid var(--accent)',
        ...
        <div className="wf-h2" style={{ fontSize: 22 }}>08:24</div>
    ...
    <Annotate style={{ top: 60, left: 140, color: 'var(--accent)' }}>↑ banner topo, não cobre conteúdo</Annotate>
  </Tablet>
);
...
const Mini_C = () => (
  <Tablet>
    ...
    <div style={{ paddingTop: 22, display: 'flex', height: '100%' }}>
      ...
      <div style={{
        width: 130, borderLeft: '2px solid var(--line)',
        background: 'var(--paper-2)', padding: 10,
        display: 'flex', flexDirection: 'column', gap: 8,
      }}>
        <div className="wf-mono" style={{ fontSize: 9 }}>EM PREPARO</div>
        {[
          { n: 'calabresa', pct: 0.55, time: '8:24', c: 'var(--accent)' },
          { n: 'cheddar ×2', pct: 0.30, time: '12:10', c: 'var(--accent)' },
        ...
        <div className="wf-btn ghost" style={{ fontSize: 11, padding: '4px 6px' }}>↗ expandir</div>
      </div>
    </div>
...
const Ready_A = () => (
  <Tablet>
    <div style={{ paddingTop: 22, height: '100%', padding: 30,
      background: 'var(--ready-soft)',
      display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 18 }}>
      <div style={{ fontSize: 80, animation: 'wiggle 1s infinite' }}>🛎️</div>
      <div className="wf-h1" style={{ fontSize: 60, color: 'var(--ink)' }}>tá pronto!</div>
      <Scribble w={180} color="var(--ready)" />
      <div style={{ fontSize: 18, textAlign: 'center' }}>
        a pizza calabresa saiu do forno.<br/>tá indo pra mesa em segundos.
      </div>
  ...
  <Tablet>
    ...
    <div style={{ paddingTop: 22 }}>
      <div style={{
        ...
        background: 'var(--ready-soft)', border: '2px solid var(--ready)', borderRadius: 10,
        ...
        <div className="wf-btn ready" style={{ fontSize: 13 }}>ok!</div>
...
const Ready_C = () => (
  <Tablet>
    ...
    <div style={{ paddingTop: 22, height: '100%', position: 'relative', overflow: 'hidden',
      ...
      <div style={{
        ...
        <div className="wf-h1" style={{ fontSize: 92, lineHeight: 1 }}>PRONTO!</div>
  ...
  <Tablet>
    ...
    <div style={{ paddingTop: 22, height: '100%', padding: 30,
      ...
      <div className="wf-box wobble" style={{
        width: 460, padding: 22, background: 'var(--paper)',
        boxShadow: '6px 6px 0 var(--line)',
      }}>
        <div className="wf-h2">precisa de algo?</div>
        <Scribble w={100} />
        <div className="wf-tiny" style={{ marginTop: 4 }}>diz pro garçom o que rolou — ele já sabe a mesa</div>
  ...
  <Tablet>
    ...
    <div style={{ paddingTop: 22, height: '100%', padding: 30,
      ...
      <div style={{ fontSize: 16, textAlign: 'center', maxWidth: 380 }}>
        avisamos o garçom — em geral <strong>2 minutos</strong>.
        se for muito urgente, balança pra alguém ali.
      </div>
      ...
      <div className="wf-btn ghost" style={{ marginTop: 8 }}>cancelar chamado</div>
    </div>
  </Tablet>
);
...
const Waiter_C = () => (
  <Tablet>
    ...
    <div style={{ paddingTop: 22, height: '100%', padding: 30, position: 'relative',
      display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 18 }}>
      ...
      <div style={{ position: 'relative', width: 360, height: 180 }}>
        {/* track */}
        <div style={{
          position: 'absolute', top: '50%', left: 0, right: 0, height: 70,
        ...
        <div style={{
          ...
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          fontSize: 32, boxShadow: '4px 4px 0 var(--line)',
  ...
  <Tablet>
    <div style={{ paddingTop: 22, padding: 16 }}>
      ...
      <div className="col" style={{ gap: 8 }}>
        {[
          { n: '#2849', t: 'agora · em preparo', items: 'pizza calabresa, hamb. cheddar', total: 162, st: 'preparing' },
          { n: '#2848', t: '20:10 · pronto', items: 'guaraná ×2, água', total: 27, st: 'ready' },
          { n: '#2847', t: '19:50 · entregue', items: 'porção de fritas, bruschetta', total: 38, st: 'done' },
        ].map((p,i) => (
          <div key={i} className="wf-box row" style={{ padding: 10, gap: 12 }}>
            <span className={`dot ${p.st === 'preparing' ? 'preparing' : p.st === 'ready' ? 'ready' : 'waiting'}`} />
            <div className="grow">
              <div className="row" style={{ gap: 10 }}>
      ...
      <div className="wf-box fill" style={{ padding: 10, marginTop: 14 }}>
        <div className="row between" style={{ fontSize: 18, fontFamily: 'var(--display)' }}>
          <span>total da mesa</span><span>R$ 227,00</span>
        </div>
    ...
    <div style={{ paddingTop: 22, padding: 16 }}>
      ...
      <div className="row" style={{ gap: 6, marginBottom: 12 }}>
        {['todos','ana','bruno','carla','diego'].map((p,i) => (
          <div key={p} className={`wf-pill${i === 0 ? ' active' : ''}`} style={{ fontSize: 12 }}>{p}</div>
        ))}
      </div>
        ...
        {[
          ...
          <div key={i} className="wf-box" style={{ padding: 10 }}>
            ...
            <div className="col" style={{ gap: 2, marginTop: 4, fontSize: 12 }}>
              {p.items.map((it,j) => <div key={j}>· {it}</div>)}
            </div>
          </div>
        ))}
      </div>
  ...
  <Tablet>
    ...
    <div style={{ paddingTop: 22, padding: 16, height: '100%' }}>
      ...
      <div className="col" style={{ gap: 0, position: 'relative', paddingLeft: 16 }}>
        <div style={{ position: 'absolute', left: 4, top: 12, bottom: 12, width: 1.5, background: 'var(--line)', opacity: 0.4 }} />
        {[
          ...
          <div key={i} className="row" style={{ gap: 12, padding: '8px 0', position: 'relative' }}>
            <span className="dot" style={{
              ...
              background: e.c, width: 9, height: 9,
            }} />
            <span className="wf-mono" style={{ width: 50, fontSize: 11 }}>{e.t}</span>
