...
export async function createGroupAction(
  ...
  return withFeedback('grupo criado', async () => {
...
export async function updateGroupAction(
  ...
  return withFeedback('grupo atualizado', async () => {
    const productId = IdSchema.parse(formData.get('productId'));
...
export async function deleteGroupAction(
  ...
  return withFeedback('grupo removido', async () => {
    const productId = IdSchema.parse(formData.get('productId'));
    const groupId = IdSchema.parse(formData.get('groupId'));
    const { product } = await ensureGroupInProduct(groupId, productId);
...
export async function createModifierAction(
  ...
  return withFeedback('modificador adicionado', async () => {
    const productId = IdSchema.parse(formData.get('productId'));
    const groupId = IdSchema.parse(formData.get('groupId'));
...
export async function updateModifierAction(
  ...
  return withFeedback('modificador atualizado', async () => {
    const productId = IdSchema.parse(formData.get('productId'));
    const groupId = IdSchema.parse(formData.get('groupId'));
    const { product, group } = await ensureGroupInProduct(groupId, productId);
...
export async function toggleModifierAvailableAction(
  _prev: ActionState,
  formData: FormData,
): Promise<ActionState> {
  return withFeedback('', async () => {
...
export async function moveModifierAction(
  _prev: ActionState,
  formData: FormData,
): Promise<ActionState> {
  return withFeedback('', async () => {
...
export async function deleteModifierAction(
  ...
  return withFeedback('modificador removido', async () => {
    const productId = IdSchema.parse(formData.get('productId'));
    const groupId = IdSchema.parse(formData.get('groupId'));
    const { product, group } = await ensureGroupInProduct(groupId, productId);
    const id = IdSchema.parse(formData.get('id'));
