...
const KDSTicket = ({ table, num, items, time, status = 'queue', mins }) => {
  ...
  return (
    ...
    >
      ...
      {mins && (
        <div className="wf-mono" style={{ marginTop: 4, color: c.dot, textAlign: 'right' }}>
          {status === 'cooking'
            ? `${mins} min restantes`
            : status === 'late'
              ? `+${mins} min`
      ...
      {status === 'queue' && (
        <div className="wf-btn primary" style={{ fontSize: 11, padding: '4px 8px', marginTop: 4 }}>
          iniciar →
        </div>
      )}
      {status === 'cooking' && (
        <div className="wf-btn ready" style={{ fontSize: 11, padding: '4px 8px', marginTop: 4 }}>
          marcar pronto ✓
        </div>
      )}
    </div>
...
const KDS_A = () => (
  <Tablet statusBar={false}>
    ...
    >
      <div>
        ...
        <div className="col" style={{ gap: 6 }}>
          <KDSTicket
            table="07"
            num="2849"
            items={['1× pizza calabresa G', '+ borda catupiry']}
            time="20:18"
            status="queue"
            mins={22}
          />
          <KDSTicket
            table="03"
            num="2850"
            items={['2× hamb. cheddar', 'sem cebola']}
            time="20:20"
            status="queue"
            mins={12}
          />
      ...
      <div>
        <div className="wf-mono" style={{ marginBottom: 6, color: 'var(--accent)' }}>
          PREPARANDO · 3
        </div>
        <div className="col" style={{ gap: 6 }}>
          <KDSTicket
          ...
          <KDSTicket
            table="09"
            num="2843"
            items={['1× pizza 4 queijos G', 'borda cheddar']}
            time="20:00"
            status="late"
            mins={3}
          />
      ...
      <div>
        <div className="wf-mono" style={{ marginBottom: 6, color: 'var(--ready)' }}>
          PRONTO · LEVAR · 2
        </div>
        <div className="col" style={{ gap: 6 }}>
          <KDSTicket
          ...
          <KDSTicket
            table="08"
            num="2840"
            items={['2× hamb. veggie', 'extra queijo']}
            time="20:40"
            status="ready"
          />
        </div>
    ...
    <div style={{ display: 'flex', height: 'calc(100% - 32px)' }}>
      <div style={{ flex: 1.6, padding: 16, borderRight: '2px solid var(--line)' }}>
        ...
        <div className="row between" style={{ marginTop: 4 }}>
          <span className="wf-h1" style={{ fontSize: 36 }}>
            pizza portuguesa M
          </span>
          ...
          <div className="col" style={{ gap: 6, marginTop: 6, fontSize: 14 }}>
            {[
              ...
              <div
                key={i}
                className="row"
                style={{ gap: 10, color: m === '○' ? 'var(--ink-3)' : 'var(--ink)' }}
              >
                <span
                  style={{
                    width: 14,
                    color:
                      m === '✓' ? 'var(--ready)' : m === '●' ? 'var(--accent)' : 'var(--ink-3)',
                  }}
                >
                  {m}
                </span>
        ...
        <div className="row" style={{ gap: 8, marginTop: 14 }}>
          ...
          <div className="wf-btn ready" style={{ flex: 1 }}>
            marcar pronto ✓
          </div>
        </div>
      </div>
...
const KDS_C = () => (
  <Tablet statusBar={false}>
    ...
    <div style={{ padding: 12, height: 'calc(100% - 32px)' }}>
      ...
      <div
        className="row"
        style={{ paddingLeft: 80, fontFamily: 'var(--mono)', fontSize: 9, color: 'var(--ink-3)' }}
      >
        {[0, 5, 10, 15, 20, 25, 30].map((t) => (
          <div key={t} style={{ flex: 1, borderLeft: '1px dashed var(--line)', paddingLeft: 4 }}>
            +{t}m
          </div>
        ))}
      </div>
      <div className="col" style={{ gap: 6, marginTop: 6 }}>
        {[
          ...
          >
            <div style={{ width: 80, fontSize: 11, fontFamily: 'var(--display)', paddingRight: 6 }}>
              {row.st}
            </div>
              ...
              {row.items.map((it, j) => (
                <div
                  ...
                  style={{
                    position: 'absolute',
                    top: 6,
                    left: `${(it.start / 30) * 100}%`,
                    width: `${(it.w / 30) * 100 - 0.5}%`,
                    height: 26,
      ...
      <div className="row" style={{ gap: 8, marginTop: 14, paddingLeft: 80 }}>
        ...
        <Annotate style={{ position: 'static', marginLeft: 'auto' }}>
          arraste pedidos pra reordenar
        </Annotate>
      </div>
    </div>
  </Tablet>
    ...
    >
      ...
      >
        <div style={{ background: 'var(--ink)', color: 'var(--paper)', padding: '10px 14px' }}>
          ...
          <div className="wf-mono" style={{ fontSize: 10, opacity: 0.7 }}>
        ...
        <div style={{ padding: 12 }}>
          ...
          <div className="col" style={{ gap: 6 }}>
            ...
            >
              ...
              <div className="row" style={{ gap: 6, marginTop: 6 }}>
                <div className="wf-btn ready" style={{ fontSize: 11, padding: '3px 8px' }}>
                  aceitar
                </div>
          ...
          <div className="wf-mono" style={{ marginTop: 12, marginBottom: 6 }}>
            📋 PEDIDOS PRA LEVAR · 3
          </div>
          <div className="col" style={{ gap: 4, fontSize: 12 }}>
            ...
            <div
              ...
              style={{ padding: 6, background: 'var(--ready-soft)' }}
            >
  ...
  <Tablet statusBar={false}>
    ...
    >
      ...
      <div className="row" style={{ gap: 12, fontSize: 11, fontFamily: 'var(--mono)' }}>
        <span>
          <span className="dot ready" /> ok · 8
        </span>
        <span>
          <span className="dot preparing" /> chamando · 2
        </span>
        <span>
          <span className="dot waiting" /> livre · 3
        </span>
      </div>
    </div>
    <div
    ...
    >
      {[
        ...
        >
          ...
          {!t.alert && !t.tag && (
            <div className="wf-tiny">{t.st === 'waiting' ? 'livre' : 'ok'}</div>
          )}
        </div>
      ))}
    </div>
  ...
  <Tablet statusBar={false}>
    ...
    <div style={{ padding: 18, height: 'calc(100% - 32px)' }}>
      ...
      >
        ...
        <div className="wf-h1" style={{ fontSize: 30, marginTop: 4 }}>
          levar pizza calabresa pra mesa 07
        </div>
        ...
        <div className="row" style={{ gap: 8, marginTop: 12 }}>
          <div className="wf-btn ready" style={{ fontSize: 14 }}>
            peguei ✓
          </div>
          <div className="wf-btn ghost" style={{ fontSize: 14 }}>
            delegar
          </div>
      ...
      <div className="wf-mono" style={{ marginTop: 16 }}>
        DEPOIS
      </div>
      <div className="col" style={{ gap: 4, marginTop: 6, fontSize: 12 }}>
        {[
          ...
          <div key={i} className="row wf-box" style={{ padding: 6, gap: 10 }}>
            <span className="wf-mono" style={{ width: 16, color: 'var(--ink-3)' }}>
              {t.p}
            </span>
